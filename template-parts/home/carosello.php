...
<div id="caroselloHome" class="carousel slide" data-ride="carousel">
  <ol class="carousel-indicators">
    <li data-target="#caroselloControlli" data-slide-to="0" class="active"></li>
    <li data-target="#caroselloControlli" data-slide-to="1"></li>
    <li data-target="#caroselloControlli" data-slide-to="2"></li>
  </ol>
  ...
  <a class="carousel-control-next" href="#caroselloControlli" role="button" data-slide="next">
