...
?>
  ...
  <div class="row g-0 align-items-stretch">
    ...
    <!-- Immagine -->
    <div class="col-lg-6 offset-lg-1 order-1 order-lg-2 col-img">
      <?php if ($img) {
...
/* Allineamento della colonna testo */
#carosello-evidenza .col-lg-6.order-2.order-lg-1 {
  display: flex;
  align-items: center;
}
