                ...
                <div class="carousel-item <?php echo $first ? 'active' : ''; ?>">
                    <div class="container py-4">
                        <div class="row">
                                ...
                                <div class="card border-0 w-100 shadow-sm">
                                    <div class="card-body">
                                        <div class="category-top d-flex align-items-center mb-2">
                                            ...
                                            <?php if ($tipo): ?>
                                                <span class="fw-semibold text-uppercase">
                                                    <a href="<?php echo site_url('tipi_notizia/' . sanitize_title($tipo->name)); ?>" class="text-decoration-none"><?php echo strtoupper($tipo->name); ?></a>
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <?php elseif (!empty($luogo_notizia)): ?>
                                            <div class="mb-2"><i class="fas fa-map-marker-alt me-1"></i><?php echo esc_html($luogo_notizia); ?></div>
                                        <?php endif; ?>
                            ...
                            <!-- Immagine -->
                            <div class="col-lg-6 offset-lg-1 order-1 order-lg-2 d-flex align-items-center justify-content-center">
                                <?php if ($img) {
...
?>
    ...
    <div class="container py-4">
        <div class="row">
            ...
            <div class="col-lg-6 offset-lg-1 d-flex align-items-center justify-content-center">
                <?php if ($img) {
                    dci_get_img($img, 'img-fluid');
                } ?>
            </div>
