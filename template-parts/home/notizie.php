    ...
    <div class="row mb-2">
        <div class="card-wrapper px-0 card-overlapping card-teaser-wrapper card-teaser-wrapper-equal card-teaser-block-3">
            <div class="row my-4 justify-content-md-center">                 
                <a href="<?php echo dci_get_template_page_url('page-templates/novita.php'); ?>" class="btn btn-primary-outline" style="margin-top: 1px;"><svg class="icon icon-sm" aria-hidden="true"><use xlink:href="#it-calendar"></use></svg>Visualizza tutte le novità</a>                 
            </div>
        </div>
    </div>
</div>
