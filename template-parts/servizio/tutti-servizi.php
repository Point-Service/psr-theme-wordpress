...
if (strlen($servizi_maggioli_url) > 1) {
    ...
    function get_procedures_data(&$total_services)
    {
    ...
    // Inizializza la variabile per il totale dei servizi
    $total_services_loaded = 0;

    // Chiamata alla funzione per ottenere i dati e passare il totale dei servizi per riferimento
    get_procedures_data($total_services_loaded);

    // Stampa il totale dei servizi prima di visualizzare i risultati dei servizi
    echo "<p>Total services loaded: $total_services_loaded</p>";
