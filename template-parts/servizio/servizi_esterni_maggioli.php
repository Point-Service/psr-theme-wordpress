            ...
            <div class="card shadow-sm px-4 pt-4 pb-4 rounded border border-light">
                ...
                <div class="card-header border-0 p-0">
                    <?php if ($service['category']) {
                        echo '<a class="text-decoration-none title-xsmall-bold mb-2 category text-uppercase" href="'.get_term_link($categoria->term_id).'"><div class="text-decoration-none title-xsmall-bold mb-2 category text-uppercase">' . $service['category'] . '</a></div>';
                    } ?>
                </div>
