...
<a href="<?php echo $st_link ?>" style="<?= ($colore_sfondo) ? 'background-color:'.$colore_sfondo : '' ?>" class="card card-teaser <?= $colore_sfondo ? '' : '' ?>  mt-0 p-3 shadow-sm border border-light" target="_blank">
    <?php if($st_img) { ?>
