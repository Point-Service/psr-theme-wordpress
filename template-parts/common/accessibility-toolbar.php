...
<div class="dci-a11y" data-dci-a11y>
    <button type="button" class="dci-a11y-toggle" data-a11y-action="toggle" aria-expanded="false" aria-controls="dci-a11y-panel" aria-label="Accessibilità"><span class="dci-a11y-toggle-icon" aria-hidden="true">⚙️</span><span class="dci-a11y-toggle-label">Accessibilità</span></button>
