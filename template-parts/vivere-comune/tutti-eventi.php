...
$paged = max(
    1,
    (int) ($paged_from_query ? $paged_from_query : $paged_from_get)
);
            ...
            <div>
                <div class="cmp-input-search">
                    ...
                    <div class="form-group autocomplete-wrapper mb-0">
                        ...
                        <p id="autocomplete-label"
                           class="u-grey-light text-paragraph-card mt-2 mb-30 mt-lg-3 mb-lg-40">
                            <?php echo intval($the_query->found_posts); ?>
                            eventi trovati in ordine alfabetico
                        </p>
            ...
            <?php if ($the_query->max_num_pages > 1) : ?>
                ...
                <div class="row my-4">
                    ...
                    <nav class="pagination-wrapper justify-content-center col-12"
                         aria-label="Navigazione pagine eventi">
