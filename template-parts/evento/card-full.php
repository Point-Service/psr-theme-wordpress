                    ...
                    <?php if (!empty($luogo_evento)) { ?>
                        <span class="data fw-normal">
                            ...
                            if ($luogo_post && !is_wp_error($luogo_post)) {
                                ...
                                echo '<i class="fas fa-map-marker-alt"></i> <a href="' . esc_url(get_permalink($luogo_post->ID)) . '" title="' . esc_attr($luogo_post->post_title) . '" class="card-text text-secondary text-uppercase pb-3"><font color="grey" size ="2">' . esc_html($luogo_post->post_title) . '</font></a>';
                            }
                            ?>
                        </span>
