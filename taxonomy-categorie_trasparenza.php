              ...
              <div class="col-12 col-lg-8 pt-30 pt-lg-50 pb-lg-50">
                ...
                <div class="dci-at-tools">
                  ...
                  <div class="form-group mb-0 dci-at-order">
                    <label class="dci-at-order__label">Ordina per</label>
                    <select name="order_type" class="form-control">
                      <option value="data_desc" <?php selected($order, 'data_desc'); ?>>Data (Descendente)</option>
                ...
                <?php } else { ?>
                  ...
                  <div class="dci-at-empty">
                    ...
                    <div class="dci-at-empty__content">
                      ...
                      <p class="dci-at-empty__text">Prova a modificare i filtri di ricerca.</p>
                    </div>
                  </div>
