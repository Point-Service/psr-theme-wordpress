                    ...
                    <div class="footer-bottom">
						...
						<ul class="it-footer-small-prints-list list-inline mb-0 d-flex flex-column flex-md-row" style="float: right;">
                            <li class="list-inline-item d-flex">
                                <small>
                                    © <?php echo dci_get_option("nome_comune"); ?>   </small>
				    <small>
				&nbsp;| Sviluppato da </small><a class="text-primary" style="text-decoration:none;" target="_Black" href="https://www.p-service.it/" title="Point Service S.r.l" aria-label="Point Service S.r.l" aria-labelledby="footerCompanyLabel">
