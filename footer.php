...
<section class="cookiebar fade" aria-label="Gestione dei cookies" aria-live="polite">
  ...
  <p>I cookie sono piccoli file di testo che vengono memorizzati sul dispositivo dell'utente, mediante il browser, quando naviga sui siti. Questi file vengono usati per molte finalità, ad esempio: garantire il corretto funzionamento del sito e consentire analisi statistiche con dati anonimi e aggregati (tecnici e assimilati), consentire la fruizione di funzionalità e personalizzazioni avanzate (funzionali), consentire l’utilizzo dei social network e di applicazioni multimediali (terze parti), memorizzare le ricerche dell'utente sul web e inviargli messaggi pubblicitari in base al suo profilo (di profilazione).</p>
