...
/*
=====================================
RESTITUISCE INFORMAZIONI DI CONTATTO DELL'ENTE
=====================================
*/
        ...
        'callback' => function () {
            ...
            function get_menu_links($location) {
                ...
                if (has_nav_menu($location)) {
                    $menu = wp_get_nav_menu_items(get_nav_menu_locations()[$location]);
            ...
            $data["menu_col1"] = get_menu_links("menu-footer-col-1");
            $data["menu_col2"] = get_menu_links("menu-footer-col-2");
            $data["menu_col3_1"] = get_menu_links("menu-footer-col-3-1");
            $data["menu_col3_2"] = get_menu_links("menu-footer-col-3-2");

            $data["info1"] = get_menu_links("menu-footer-info-1");
            $data["info2"] = get_menu_links("menu-footer-info-2");
