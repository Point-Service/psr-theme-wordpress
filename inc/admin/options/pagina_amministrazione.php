...
function dci_register_pagina_amministrazione_options(){
    ...
    $amministrazione_options->add_field( array(
        ...
        $amministrazione_options->add_field(array(
            ...
            'desc'    => __('Con questa funziona puoi attivare la parte aggiuntiva Commissario OSL. Si ricorda che bisogna creare un Ufficio con il nome "Commissario OSL" e in Novità la tipologia "Avvisi OSL" e in Documenti e dati creare la Tipologia "Documenti OSL" ', 'design_comuni_italia'),
            'type'    => 'radio_inline',
            'default' => 'true', // Imposta il valore predefinito su 'true'
            'options' => array(
                'true'  => __('Sì', 'design_comuni_italia'),
