...
function dci_register_taxonomy_tipi_commissario() {
    ...
    $labels = array(
        'name'              => _x( 'Tipi di documento Commissario', 'taxonomy general name', 'design_comuni_italia' ),
        'singular_name'     => _x( 'Tipo di documento Commissario', 'taxonomy singular name', 'design_comuni_italia' ),
        'search_items'      => __( 'Cerca Tipo di Documento Commissario', 'design_comuni_italia' ),
        'all_items'         => __( 'Tutti i Tipi di Documento Commissario', 'design_comuni_italia' ),
        ...
        'add_new_item'      => __( 'Aggiungi un Tipo di Documento Commissario', 'design_comuni_italia' ),
        'new_item_name'     => __( 'Nuovo Tipo di Documento Commissario', 'design_comuni_italia' ),
        'menu_name'         => __( 'Tipi di Documento Commissario', 'design_comuni_italia' ),
    );
