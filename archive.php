            ...
            <div class="row">
                <div class="col px-lg-4">
                        ...
                        if ($archive_title !== 'Dataset') {
                            ...
                            echo '<p></p><nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="' . home_url() . '">Home</a></li><li class="breadcrumb-item active" aria-current="page">Amministrazione Dataset</li></ol></nav>';
                        }
                        ?> 
                </div>
            </div>
