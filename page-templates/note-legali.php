    ...
    <div class="row mt-lg-50">
        ...
        <div class="col-12 col-lg-8 offset-lg-1">
            ...
            <article id="cos-e" class="it-page-section anchor-offset">
                        ...
                        <div class="the-content"><p data-element="legal-notes-body"> In applicazione del principio open by default ai sensi dell’articolo 52 del decreto legislativo 7 marzo 2005, n. 82 (CAD) e salvo dove diversamente specificato
				(compresi i contenuti incorporati di terzi), i dati, i documenti e le informazioni pubblicati sul sito sono rilasciati con licenza CC-BY 4.0.</p>
				...
				derivate) per qualsiasi fine, anche commerciale con il solo onere di attribuzione, senza apporre restrizioni aggiuntive.</p><br />      
				<p><strong>Premessa</strong><br />Nel rispetto delle Linee guida per i siti web della PA (art. 4 della Direttiva 8/09 del Ministro per la pubblica amministrazione e l'innovazione) si forniscono le seguenti informazioni che regolano l'accesso al sito web e disciplinano i termini e le condizioni d'uso del sito stesso. Accedendo e consultando questo sito, il visitatore ne accetta i seguenti termini e condizioni d'uso.<br /><br />
					<strong>Copyright</strong><br />Tutti i contenuti, le immagini e le informazioni presenti all'interno del sito sono protetti ai sensi delle normative sul diritto d'autore, sui brevetti e su quelle relative alla propriet&agrave; intellettuale; pertanto nulla, neppure in parte, potr&agrave; essere copiato, modificato o rivenduto per fini di lucro o per trarne qualsivoglia utilit&agrave;.<br /><br />
					<strong>Utilizzo del sito</strong><br /><p data-element="legal-notes-body">In nessun caso l'Ente potr&agrave; essere ritenuto responsabile dei danni di qualsiasi natura causati direttamente o indirettamente dall'accesso al sito e dall'utilizzo che venga fatto delle informazioni in esso contenute; inoltre, l'Ente non ha alcuna responsabilit&agrave; per eventuali problemi causati dall'utilizzazione del presente sito o di siti ad esso collegati.<br />
