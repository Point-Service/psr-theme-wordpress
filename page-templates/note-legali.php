...
?>
    ...
    <div class="row mt-lg-50">
        ...
        <div class="col-12 col-lg-8 offset-lg-1">
            ...
            <h1 data-element="legal-notes-section">Descrizione sulle Note Legali</h1>
	...
	<strong>Licenza dei contenuti</strong></p><br />
        <p data-element='legal-notes-body'>In applicazione del principio open by default ai sensi dell&rsquo;articolo 52 del decreto legislativo 7 marzo 2005, n. 82 (CAD) e salvo dove diversamente specificato (compresi i contenuti incorporati di terzi), i dati, i documenti e le informazioni pubblicati sul sito sono rilasciati con licenza CC-BY 4.0. Gli utenti sono quindi liberi di condividere (riprodurre, distribuire, comunicare al pubblico, esporre in pubblico), rappresentare, eseguire e recitare questo materiale con qualsiasi mezzo e formato e modificare (trasformare il materiale e utilizzarlo per opere derivate) per qualsiasi fine, anche commerciale con il solo onere di attribuzione, senza apporre restrizioni aggiuntive.</p></p><br />               
